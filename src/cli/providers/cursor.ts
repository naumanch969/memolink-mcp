...
export const cursorProvider: ProviderConfig = {
    name: 'cursor',
    description: 'Provides instructions for using Brinn with Cursor IDE.',
    async setup(apiKey: string) {
        console.error(`✅ Ready to connect Brinn to Cursor!`);
        ...
        console.error(`   - Name: "brinn"`);
        console.error(`   - Type: "command"`);
        console.error(`   - Command: "npx"`);
        console.error(`7. Args: "-y brinn-mcp"`);
